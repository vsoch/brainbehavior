...
outfolder = "/share/PI/russpold/work/PUBMED/counts"

# This pickle has a list of our terms
term_pickle =  "/home/vsochat/SCRIPT/brainbehavior/brainbehavior/data/cognitiveatlas/behavioraltraits.pkl"
...
for s in range(0,len(subfolders)):
    ...
    if not os.path.exists("%s/%s_counts.pkl" %(outfolder,subfolder)):
        ...
        jobfile.writelines("python /home/vsochat/SCRIPT/brainbehavior/analysis/pubmed/1.count.py %s %s %s %s\n" %(topfolder,subfolder,term_pickle,outfolder))  
        jobfile.close()
